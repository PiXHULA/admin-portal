...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final JpaUserDetailService myUserDetailsService;
    private final JwtRequestFilter jwtRequestFilter;

    @Autowired
    public SecurityConfig(JpaUserDetailService myUserDetailsService, JwtRequestFilter jwtRequestFilter){
